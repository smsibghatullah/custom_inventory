...
[www.dsmpk.com](http://www.dsmpk.com)
    ...
    'depends': ['base','stock','sale','purchase','account','purchase_stock','crm', 'sale_crm','delivery','project','survey','product','maintenance','hr_maintenance','gsk_automatic_mail_server'],
